...
extern int x86_64_signal_dispatch( arch_thread_t   *thread, thread_entry_t  entry,
    siginfo_t *info, sigaction_t *sigact);

extern int arch_thread_execve(arch_thread_t *thread, thread_entry_t entry,
...
extern int arch_signal_dispatch(arch_thread_t *thread, thread_entry_t entry, siginfo_t *info, sigaction_t *sigact);