...
extern unsigned int sys_alarm(unsigned int sec);
extern int  sys_sigpending(sigset_t *set);
extern int  sys_kill(pid_t pid, int signo);
extern int  sys_sigaction(int signo, const sigaction_t *act, sigaction_t *oact);
extern int  sys_sigaltstack(const uc_stack_t *ss, uc_stack_t *oss);
extern int  sys_sigprocmask(int how, const sigset_t *set, sigset_t *oset);
extern int  sys_sigsuspend(const sigset_t *mask);
extern int  sys_sigwaitinfo(const sigset_t *set, siginfo_t *info);
extern int  sys_sigtimedwait(const sigset_t *set, siginfo_t *info, const struct timespec *timeout);
extern int  sys_pthread_kill(tid_t thread, int signo);
extern int  sys_pthread_sigmask(int how, const sigset_t *set, sigset_t *oset);
extern int  sys_pthread_sigqueue(tid_t tid, int signo, union sigval sigval);
