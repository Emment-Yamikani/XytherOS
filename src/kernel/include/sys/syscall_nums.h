...
#define SYS_write               10  // ssize_t sys_write(int fd, const void *buf, size_t size);
#define SYS_open                11  // int sys_open(const char *pathname, int oflags, mode_t mode);
#define SYS_create              12  // int sys_create(const char *filename, mode_t mode);
...
#define SYS_getmemstats         131  // int sys_getmemstats(meminfo_t *info);
