...
#define proc_assert(proc)               ({ assert(proc, "Invalid proc.\n"); })
...
#define proc_recursive_lock(proc)       ({ proc_assert(proc); spin_recursive_lock(&(proc)->lock); })
#define proc_try_lock(proc)             ({ proc_assert(proc); spin_try_lock(&(proc)->lock); })
