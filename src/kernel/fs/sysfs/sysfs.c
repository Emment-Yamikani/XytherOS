...
int sysfs_iopen(inode_t *ip __unused, inode_t **pip __unused) {
    return 0;
}
...
ssize_t sysfs_iwrite_data(inode_t *ip __unused, off_t off __unused, const void *buf __unused, size_t nb __unused) {
    return -ENOSYS;
}
